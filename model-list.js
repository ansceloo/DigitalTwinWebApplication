...
for(let project of projects) {
    ...
    const cardSubTitle = newCard.querySelector('h3');
    cardSubTitle.textContent = project.id;

    const cardAddress = newCard.querySelector('h5');
    cardAddress.textContent = project.address;

    const cardFigure = newCard.querySelector('img');
    cardFigure.textContent = project.figure;
